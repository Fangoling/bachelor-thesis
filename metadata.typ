...
#let titleEnglish = "Enhancing Terminal Usability in Modern IDEs Through AI-Assisted Interaction"
...
#let startDate = datetime(day: 1, month: 12, year: 2025)
#let submissionDate = datetime(day: 1, month: 4, year: 2026)
